...
import PostsWithChanges from './PostsWithChanges.jsx';
        ...
        return (
            <div>
                ...
                <div style={columnStyle}>
                 ...
                 <div style={columnStyle}>
                    <h1>Posts with changes</h1>
                    {this.state.selectedUser
                        ? <PostsWithChanges onSelect={this.onSelectPost.bind(this)}  params={{ownerId: this.state.selectedUser}}  />
                        : <div>Select a user first</div>
                    }
                </div>
